<template>
  <section class="add">
    ...
    <el-main>
    <el-form-item>
       <button @click='getResult()' v-trigger>权限提升方法</button>
    ...
    <!-- <div>工具使用示例</div> -->
    <div v-if="form.toolname=='获取交互式shell，脏牛提权，获取root权限'">
     <a>获取交互式shell<img src="\images\1-1.png" alt=""></a>
     <a>脏牛提权<img src="\images\1-2.png" alt=""></a>
     <a>获取root权限<img src="\images\1-3.png" alt=""></a>
    </div>
    <div v-if="form.toolname=='反弹shell，获取交互式shell，写入文件，获取root权限'">
     <a>反弹shell<img src="\images\2-1.png" alt=""></a>
     <a>获取交互式shell<img src="\images\2-2.png" alt=""></a>
     <a>写入文件<img src="\images\2-3.png" alt=""></a>
     <a>获取root权限<img src="\images\2-4.png" alt=""></a>
    </div>
    <div v-if="form.toolname=='获取交互式shell，md5解密，ssh连接，获取root权限'">
     <a>获取交互式shell<img src="\images\3-1.png" alt=""></a>
     <a>md5解密<img src="\images\3-2.png" alt=""></a>
     <a>ssh连接<img src="\images\3-3.png" alt=""></a>
     <a>获取root权限<img src="\images\3-4.png" alt=""></a>
    </div>
    <div v-if="form.toolname=='获取交互式shell，37292.c提权，获取root权限'">
     <a>获取交互式shell<img src="\images\4-1.png" alt=""></a>
     <a>提权<img src="\images\4-2.png" alt=""></a>
     <a>获取root权限<img src="\images\4-3.png" alt=""></a>
    </div>
    <div v-if="form.toolname=='获取交互式shell，枚举，强制登录，获取root权限'">
     <a>获取交互式shell<img src="\images\5-1.png" alt=""></a>
     <a>枚举<img src="\images\5-2.png" alt=""></a>
     <a>强制登录<img src="\images\5-3.png" alt=""></a>
     <a>获取root权限<img src="\images\5-4.png" alt=""></a>
    </div>
...
export default {
  ...
  methods: {
    ...
    getResult:function() {
        var _this = this
        _this.$axios.get('http://127.0.0.1:5000/api/tqs/?name='+_this.form.toolname).then
        (function(resp){
